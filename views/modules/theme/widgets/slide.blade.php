...
<div class="top-area show-onload">
    <div class="bg-holder full">
        <div class="bg-front bg-front-mob-rel" style="background-image: url({{ $slides[0]->present()->firstImage(null,700,'resize',80) }})">
            <div class="container">
                <div class="search-tabs search-tabs-bg search-tabs-abs mt50">
                    <h2>Size özel fiyat ve koşullarda araç kiralayın</h2>
                    <div class="search-form">
                        <h2>En iyi fiyat ve en iyi hizmet için bizimle hemen iletişime geçin</h2>
...
@push('js-stack')
    ...
    <script src="{{ mix('/themes/otorent/js/datetime.min.js') }}" defer></script>
@endpush
