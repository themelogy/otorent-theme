...
<!-- /GOOGLE FONTS -->
<link media="all" rel="stylesheet" type="text/css" href="{{ mix('/themes/otorent/css/bootstrap.css') }}">
{!! Theme::style('css/font-awesome.css') !!}
{!! Theme::style('css/icomoon.css') !!}
<link media="all" rel="stylesheet" type="text/css" href="{{ mix('/themes/otorent/css/styles.css') }}">
